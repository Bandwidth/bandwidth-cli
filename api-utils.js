...
/*
FIXME I really think that this whole thing should really be a functional program.
There are very few states associated with making an API and ordering numbers. Other
possible functionality such as walktroughts and the like and are effectively
dealt with through a purely functional paradigm. I don't see why we need classes for this, to be honest.
*/
class Api {
  constructor() {
